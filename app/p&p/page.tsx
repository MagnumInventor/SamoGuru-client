        ...
        <TabsContent value="privacy">
          <Card className="mb-6 border-blue-200">
            <CardHeader className="pb-3">
              ...
              <div className="text-sm text-gray-600">
                <strong>Дата останнього оновлення:</strong> 15 червня 2025 року
              </div>
            </CardHeader>
          </Card>
          ...
          <div className="space-y-6">
            <Card>
              ...
              <CardContent>
                <p className="text-gray-700">
                  Сайт "САМоГуру" (далі - "Компанія", "ми") зобов'язується захищати конфіденційність персональних даних 
                  користувачів платформи САМоГуру (далі - "Платформа"). Ця Політика конфіденційності описує, 
            ...
            <Card>
              ...
              <CardContent>
                ...
                <ul className="list-disc pl-6 space-y-2 text-gray-700">
                  <li>Персональна сторінка працівника</li>
                  <li>Управління змінами робочого розкладу</li>
                  <li>Статистика навчання та тестування</li>
                  <li>Адміністративна панель користувача</li>
                </ul>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-gray-700">
                  <strong>Станом на 15.06 платформа НЕ використовує дані користувача</strong>, 
                  через відсутність серверної складової сайту.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <ul className="list-disc pl-6 space-y-2 text-gray-700">
                  <li>Дані зберігаються на серверах Vercel (відповідають GDPR)</li>
                  <li>Термін зберігання: 3 роки після припинення співпраці</li>
                  <li>Дані шифруються під час передачі та зберігання</li>
                </ul>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-gray-700">
                  Ми не продаємо, не передаємо та не розголошуємо персональні дані третім особам, 
        ...
        <TabsContent value="terms">
          ...
          <div className="space-y-6">
            <Card>
              ...
              <CardContent>
                <p className="text-gray-700">
                  Ці Умови використання регулюють відносини між ТОВ "САМоГуру" та користувачами платформи 
                  САМоГуру - системи управління персоналом ресторану.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-gray-700">
                  Компанія залишає за собою право змінювати ці умови з повідомленням користувачів 
