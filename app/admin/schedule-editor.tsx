        ...
        <ProtectedRoute>
            <div className="min-h-screen bg-gray-50 p-6">
                <div className="max-w-7xl mx-auto space-y-6">
                    ...
                    <Card>
                        <CardHeader>
                            <CardTitle>Редактор розкладу</CardTitle>
                            <CardDescription>
                                Створення та редагування розкладу для працівників
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                            {/* Excel-like table for schedule editing */}
                            <div className="mb-4">
                                <Button 
                                    variant="outline" 
                                    className="border-green-200 text-green-600 hover:bg-green-50"
                                    onClick={() => {}} // TODO: Add template logic
                                >
                                    Використати шаблон 3/3
                                </Button>
                                <Button 
                                    variant="outline" 
                                    className="border-blue-200 text-blue-600 hover:bg-blue-50"
                                    onClick={() => {}} // TODO: Add student template logic
                                >
                                    Використати шаблон студент
                                </Button>
                            </div>
                            ...
                            <div className="mb-4">
                                ...
                                <label htmlFor="import-schedule">
                                    ...
                                    >
                                        {isImporting ? 'Імпортування...' : 'Імпортувати розклад з Excel'}
                                    </Button>
                                </label>
                            </div>

                            {/* Display imported schedules */}
                            <div>
                                {schedules.length === 0 && (
                                    <div className="text-center py-4 text-gray-500">
                                        <p>Розклад ще не імпортовано</p>
                                    </div>
                                )}
                                {schedules.map((schedule: any) => (
                                    <div key={schedule.id} className="p-4 border rounded-lg mb-4">
                                        <div className="flex items-center justify-between mb-2">
                                            <h3 className="text-lg font-semibold">{schedule.name}</h3>
                                            <Button 
                                                variant="ghost" 
                                                size="icon"
                                                onClick={() => {}} // TODO: Add delete schedule logic
                                        ...
                                        <div className="text-sm text-gray-600 mb-2">
                                            Імпортовано: {formatDate(schedule.importedAt)}
                                        </div>
                                        <Button 
                                            className="w-full bg-blue-500 hover:bg-blue-600 text-white"
                                            onClick={() => {}} // TODO: Add view/edit schedule logic
                                        >
