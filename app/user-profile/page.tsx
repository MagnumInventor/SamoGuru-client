        ...
        <CardContent>
          <div className="space-y-4">
            ...
            <div className="text-sm text-muted-foreground">
              ...
              {user.role === "admin" &&
                "Менеджер має повний доступ до всіх функцій системи, включаючи управління користувачами."}
            </div>
            {user.role === "admin" && (
              <Alert>
                <Shield className="h-4 w-4" />
                <AlertDescription>
                  Ви маєте права Менеджера. Будьте обережні при внесенні змін до системи.
                </AlertDescription>
              </Alert>
            )}
          </div>
