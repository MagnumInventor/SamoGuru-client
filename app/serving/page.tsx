...
const servingRules = {
  food: {
    title: "Їжа",
    icon: "🍽️",
    description: "Правила сервірування страв для ранерів офіціантів",
    items: [
      {
        id: 1,
  ...
  drinks: {
    title: "Напої",
    icon: "🥤",
    description: "Правила сервірування напоїв для ранерів офіціантів",
    items: [
      {
        id: 17,
        name: "Соки",
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        ...
        <p className="text-gray-600">Правила подачі страв та напоїв для ранерів офіціантів</p>
      </div>
      ...
      <div className="mt-12 space-y-6">
        <Card className="border-red-200 bg-red-50">
          ...
          <CardContent className="text-sm text-red-700 space-y-3">
            ...
            <div>
              <strong>2. Перевірка офіціантом:</strong> Всі страви та напої сервіруються ранером, але на станції
              (перед видачею) офіціант перевіряє подачу та може виправити помилку ранера.
            </div>
            <div>
