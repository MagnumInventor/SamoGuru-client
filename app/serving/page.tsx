...
const servingRules = {
    ...
    items: [
      {
        ...
        rules: [
          "Подавати в склянці з льодом",
          "Обов'язково з трубочкою",
          "Серветка під склянку",
          "Трубочка має бути в упаковці до моменту подачі",
        ],
        examples: ["Апельсиновий сік", "Яблучний сік", "Томатний сік"],
      ...
      },
      {
        ...
        rules: [
          "Подавати в відповідній склянці для коктейлю",
          "З трубочкою та декором",
          "Серветка обов'язкова",
          "Прикраси згідно з рецептом",
        ],
        examples: ["Мохіто", "Піна Колада", "Лимонад", "Смузі"],
        image: "/placeholder.svg?height=300&width=400",
      },
      {
        id: 3,
        ...
        rules: [
          ...
          "З трубочкою та серветкою",
          "Можна додати шматочок фрукта для декору",
        ],
        examples: ["Апельсиновий фреш", "Грейпфрутовий фреш", "Мікс фрешів"],
        image: "/placeholder.svg?height=300&width=400",
      },
    ],
  },
  coffee: {
    ...
    items: [
      ...
      },
      {
        ...
        rules: [
          "Подавати в більшій чашці (150-200 мл)",
          "На блюдці з кавовою ложечкою",
          "Печево на блюдці",
      ...
      },
      {
        ...
        rules: [
          "Подавати в чашці для еспресо або трохи більшій",
          "На блюдці з кавовою ложечкою",
          "Печево на блюдці",
          "Подавати гарячим одразу після приготування",
        ],
  ...
  beer: {
    ...
    icon: "🍺",
    description: "Спеціальне сервірування для пива",
    items: [
      {
        id: 8,
        name: "1 літрове пиво",
        ...
        rules: [
          "Подавати в спеціальному літровому келиху",
          "Обов'язково з бочонком соняшникового насіння",
          "Бочонок ставити поруч з келихом",
          "Серветки для рук (через насіння)",
          "Пиво має бути охолодженим (4-6°C)",
          "Піна 2-3 см",
        ],
        volume: "1000 мл",
        temperature: "4-6°C",
      ...
      <div className="mt-12">
        <Card className="border-green-200 bg-green-50">
          ...
          <CardContent className="text-sm text-green-700 space-y-3">
            ...
            <div>
              <strong>Температура:</strong> Гарячі напої подавати гарячими, холодні - охолодженими.
            </div>
            <div>
              <strong>Презентація:</strong> Акуратно розміщуйте всі елементи сервірування на підносі.
            </div>
            <div>
              <strong>Швидкість:</strong> Кавові напої подавати одразу після приготування, поки не остигли.
            </div>
            <div>
              <strong>Увага до деталей:</strong> Серветки, ложечки, прикраси - все має бути на своєму місці.
            </div>
          </CardContent>
        </Card>
      </div>
