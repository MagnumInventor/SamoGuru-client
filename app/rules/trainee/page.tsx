...
const rules = [
  ...
  },
  {
    ...
    rules: [
      ...
      "Повідомляти Менеджерістрації + колегу по станції про бажання вийти на перекур/перерву",
  ...
  },
  {
    ...
    rules: [
      "НЕ заряджати власні телефони на фірмових павер-банках",
      "НЕ керувати ліфтом коли він не на своїй станції",
      "НЕ перегружати ліфт брудним, чи погано складеним посудом",
      "ОБОВ'ЯЗКОВО повідомляти Менеджерістрації + колег по станції поломки/неполадки з обладнанням",
      "ДОТРИМУВАТИСЯ базових правил та принципів безпечного користування технікою",
    ],
  },
]
...
const newOrders = [
    ...
    description: "У наступні дні 2 зміна ранерів починається о 12:00 (замість 16:00): ПТ, СБ, НД",
    priority: "medium",
    deadline: "25.05.2025",
    status: "active",
  },
  {
    ...
    description: "За відсутність звіту під кінець зміни (фото надіслане Менеджерістрації) про відповідний стан форми передбачений штраф в залежності від стану одяу",
    priority: "low",
    deadline: "19.05.2025",
    status: "active",
  },
  {
    ...
    description: "За наступним правилом: 1 хв запізнення - 15 грн штрафу",
    priority: "medium",
    deadline: "18.05.2025",
    status: "active",
  },
  {
    ...
    description: "Волосся чисте та заплетене, охайний вигляд, макіяж / нігті не яскраві, в натуральних тонах",
    priority: "medium",
    deadline: "20.05.2025",
    status: "active",
  },
  {
    id: 4,
    title: "Штраф за нецензурні слова при гостях, Менеджерістрації",
    description: "1 мат - 50 грн штрафу",
    priority: "hard",
    deadline: "21.05.2025",
    status: "active",
  },
  {
    id: 5,
    title: "Чергування в КП (від 22.06)",
    description: "В нові обов'язки ранерів на станції Кухня тепер є прибирання, чергування КП та відповідний звіт під кінець зміни",
    priority: "medium",
    deadline: "22.05.2025",
    status: "active",
  },
...
const tasks = [
  ...
  },
  {
    ...
    description: "Почати/закінчити свою зміну на початку/кінці робочого дня",
