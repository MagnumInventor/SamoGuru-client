...
const rules = [
  ...
  },
  {
    ...
    rules: [
      ...
      "ОБОВ'ЯЗКОВО повідомляти адміністрації + колег по станції поломки/неполадки з обладнанням",
...
const newOrders = [
  ...
  },
  {
    ...
    description: "За відсутність звіту під кінець зміни (фото надіслане адміністрації) про відповідний стан форми передбачений штраф в залежності від стану одяу",
    priority: "low",
    deadline: "19.05.2025",
    status: "active",
  },
  ...
  {
    id: 4,
    title: "Штраф за нецензурні слова при гостях, адміністрації",
