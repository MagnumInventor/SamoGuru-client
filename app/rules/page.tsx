...
const rules = [
  {
    ...
    rules: [
      ...
      "Не використовуйте мобільний телефон у присутності гостей",
  ...
  },
  {
    ...
    rules: [
      "Підходьте до столу протягом 2 хвилин після посадки гостей",
      "Завжди тримайте блокнот та ручку під рукою",
      "Повторюйте замовлення для підтвердження",
      "Подавайте страви з правого боку гостя",
      "Прибирайте порожні тарілки лише після дозволу гостя",
    ],
  },
  {
    ...
    rules: [
      ...
      "Негайно прибирайте розлиті рідини для запобігання падінням",
      "Повідомляйте про будь-які проблеми з обладнанням",
      "Дотримуйтесь температурного режиму для страв",
      "Використовуйте захисні засоби при роботі з хімікатами",
    ],
  },
]
...
const newOrders = [
  {
    id: 1,
    title: "Нове меню літнього сезону",
    description: "Ознайомтеся з новими стравами та напоями",
    priority: "high",
    deadline: "25.01.2024",
    status: "active",
  },
  ...
  },
  {
    ...
    description: "Обов'язковий тренінг для всіх офіціантів",
    priority: "high",
    deadline: "28.01.2024",
    status: "completed",
  },
...
const tasks = [
  {
    id: 1,
    title: "Щоденне прибирання робочого місця",
    description: "Підтримання чистоти та порядку",
    frequency: "Щодня",
    status: "ongoing",
  },
  {
    id: 2,
    title: "Перевірка запасів серветок та приборів",
  ...
  },
  {
    ...
    description: "Заповнення звіту в кінці робочого дня",
    frequency: "Кінець зміни",
    status: "ongoing",
  },
]
