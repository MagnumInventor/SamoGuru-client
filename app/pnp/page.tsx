        ...
        <TabsContent value="privacy">
          ...
          <div className="space-y-6">
            ...
            <h2>1.1 Використані поняття:</h2>
                ...
                <p className="text-gray-700">
                  Акаунт - обліковий запис користувача що передбачає доступ до персональної сторінки користувача на платформі, що містить персональні дані, конфіденційні дані, а також інформацію про роль користувача (TRAINEE - (Стажер), HELPER - (Помічник офіціанта - Ранер), WAITER - (Офіціант), ADMIN - (Менеджер - Адміністратор)).
                </p>
                <p className="text-gray-700">
            ...
            <Card>
              ...
              <CardContent>
                ...
                <ul className="list-disc pl-6 space-y-2 text-gray-700">
                  ...
                  <li>Сторінки з інформацією для стажування помічників та офіціантів</li>
