...
return (
      ...
      <><AutoRefresh intervalMinutes={10} enabled={true} /><div className="min-h-screen bg-gradient-to-br from-orange-900 via-red-800 to-orange-700 flex items-center justify-center relative overflow-hidden py-8">
